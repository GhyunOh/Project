...
## 2021 Big Data Innovation Project  
**Marine Platform Data Correlation Analysis**
...
### 🛠️ Data Description
- **Environmental Data:** AIRGAP, CURRENT_DEPTH, CURRENT_SPEED, WIND_DIRECTION, WIND_SPEED  
- **Buoy Data:** MOORING_TENSION, MOORING_LENGTH, MOTION_TILT(X, Y), MOTION_YAW, POSITION(X, Y)  
- **Datasets Used:** 2015-08-07, 2015-08-08, 2015-09-03, 2015-09-07, 2015-09-11  

### 🔎 Key Steps
1. **Data Preprocessing & Outlier Detection**  
   - Removed sensor errors and irregular patterns (e.g., Aug 7–8).  
   - Selected stable datasets (e.g., Sept 7) as training data.  
...
3. **Machine Learning Models**  
   - Applied **Linear Support Vector** and **XGBoost**.  
   - Tuned hyperparameters while preventing overfitting.  
   - Trained on Sept 7 data and predicted Sept 11 data.  
...
### 🔎 Model Comparison: LinearSVR vs. XGBoost
